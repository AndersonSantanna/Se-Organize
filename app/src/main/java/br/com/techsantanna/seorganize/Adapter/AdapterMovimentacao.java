package br.com.techsantanna.seorganize.Adapter;
...
public class AdapterMovimentacao extends RecyclerView.Adapter<AdapterMovimentacao.MyViewHolder> {
    ...
    /**Trantando lista de movimentaçṍes para o recycler view*/
    @Override
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.data.setText(movimentacao.getDataBD());
        //cores dos valores
        if (movimentacao.getTipo() == "despesa" || movimentacao.getTipo().equals("despesa")) {
            ...
            holder.valor.setTextColor(context.getResources().getColor(R.color.saldoPositivo));
        }
    }
